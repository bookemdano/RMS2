...
namespace Jiranator
{
    ...
    static public class JiraAccess
    {
        ...
        {
            return _latestApi + @"/search?jql=text~'" + text + "' OR Issue='" + text + "'&maxResults=200";
        }
    ...
    public class JiraIssueViewModel : JiraIssue, INotifyPropertyChanged
    {
        ...
        public string ShortAssignee
        {
            get
            {
                if (string.IsNullOrWhiteSpace(Assignee))
                    return "-";
                return Assignee.Substring(0,2).ToUpper();
            }
        }
    ...
    public class JiraSprint
    {
        ...
        internal static JiraSprint Parse(SprintKey sprintKey, JObject json)
        {
            ...
            if (sprintKey != null)
                rv.SetSprintName(sprintKey.ToString());
            return rv;
        }
